...
error_reporting(1);
$q="SELECT * FROM users WHERE del=1 ORDER BY Id DESC";
	$a=mysqli_query($dbc,$q);

if(isset($_GET['deluser'])){
	if($_GET['deluser'] != '1'){
		$id = $_GET['deluser'];
		$del = "UPDATE users SET del=0 WHERE id=$id";
                    ...
                    <table class="table">
                      ...
                      <tbody>
							...
							while($data = mysqli_fetch_row($a)){
								...
								echo "<td>";
								echo "<img src='../../$data[8]' style='height: 100px; width: 100px'>";
								echo "</td>";
								
								echo "<td>";?>
								
								<?php if($data[0] != 1){?>
								<a class="btn btn-danger" href="javascript:deluser('<?php echo $data[0];?>','<?php echo $data[1];?>')">Del</a>
								<?php
								echo "</td>";
								echo "</tr>";
								}}?>
